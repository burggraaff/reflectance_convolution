...
axs[0].set_title("Tara Ocean spectra")
plt.savefig("Tara_ocean_spectra.pdf")
plt.show()
plt.close()

data.write("data/tara_ocean_processed.tab", format="ascii.fast_tab", overwrite=True)
